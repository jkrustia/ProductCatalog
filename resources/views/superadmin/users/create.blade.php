...
@section('content')
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <input type="text" class="form-control fw-bold mb-4 @error('name') is-invalid @enderror"
                        ...
                        id="name" name="name" placeholder="Name of Employee" value="{{ old('name') }}" required>
                    @error('name')
                    ...
                    <div class="mb-2 d-flex align-items-center">
                        ...
                        <input type="email" class="form-control tamad-nunito ms-2 d-inline-block @error('email') is-invalid @enderror"
                            ...
                            placeholder="employee@email.com" value="{{ old('email') }}" required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-2 d-flex align-items-center">
                        ...
                        <input type="text" class="form-control tamad-nunito ms-2 d-inline-block"
                            style="width: auto; min-width: 120px;" id="username" name="username" placeholder="username" value="{{ old('username') }}">
                        <small class="text-muted ms-2">Optional - will use email if not provided</small>
                    </div>
                    ...
                    <div class="mb-2 d-flex align-items-center">
                        ...
                        <input type="password" class="form-control tamad-nunito ms-2 d-inline-block @error('password') is-invalid @enderror"
                            style="width: auto; min-width: 120px;" id="password" name="password" placeholder="password" required>
                    ...
                    <div id="permissions-list" class="d-flex flex-wrap gap-2">
                        <span class="text-muted">Select a role to see permissions</span>
                    </div>
                </div>
                <div class="text-end">
    ...
    <script>
        ...
        function renderPermissions(perms, role) {
            ...
            if (perms.length === 0) {
                permissionsList.innerHTML = '<span class="text-muted">Select a role to see permissions</span>';
                return;
            }
        ...
        // Set initial permissions based on selected value
